...
objsave(trans.anc, './data/processed/teefyref_annotation/trans.anc2')

preds = TransferData(anchorset = trans.anc, 
                     refdata = killi.combined.filt$Annotation_v1, 
                     dims = 1:30)
objsave(preds, './data/processed/teefyref_annotation/preds2')
...
objsave(pred_mat, './data/processed/teefyref_annotation/pred_mat2')
pred_rel_mat = pred_mat/rowSums(pred_mat) * 100
objsave(pred_rel_mat, './data/processed/teefyref_annotation/pred_rel_mat2')
pheatmap::pheatmap(t(pred_rel_mat), 
                   ...
                   number_format = '%.0f', filename = './results/scRNAseq/teefyref_annotation/annotation_dist2.pdf')
